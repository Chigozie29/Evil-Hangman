#include <stdio.h>
#include <stdlib.h>
#include <ctype.h>//ctype.h is only used in lab 5 as a reference library
// isspace -> you can write your own int is_space (char A){}
// strlen - > you can iterate with a while loop over a string until you find '\0'
#include "my_string.h"
#include "generic_vector.h"
#include "associative_array.h"
//TO DO
//1. Move my_string structure implementation from my_string.h to my_string.c
//2. What is void*? typdef void* MY_STRING; -> what's the difference between a regular pointer and a handle
//3. Is my_string->data stored inside of My_String or is it stored separately?
//4. What is casting? Is necessary? Can we remove it and where?
//5. If there is a pointer like int* a = 5; Is there a difference between a and &a? Is there a difference between a and *a;
//6. What is the difference between the size and the capacity? Can those be equal? 
//----Lab 3
//1. What is stdout and why is it treated as a file pointer?
//2. Why do you use ungetc()? Why not? Why yes?
//3. Throw some extra ' ' and '\n' in your simple txt, and check if you are skipping extra spaces correctly
//---Lab 4 
//1. Pushback a word 10 times, pop it back 50 times, push it back again, print out the result 
//2. Concatinate: a) two empty strings b) two very long strings c) an empty string and a long string
//3. Make sure pop_back actually removes a charachter from the data
